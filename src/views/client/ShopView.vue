          ...
          <div>
            <Panel :header="$route.params.brand" toggleable>
              <ul class="list-unstyled">
                <li>
                  <div
                    class="d-flex items-center gap-2 mt-2"
                    v-for="item in items"
                    :key="item"
                  >
                    <RadioButton
      ...
      <div class="col">
        <div class="ms-3">
          ...
          <h5 class="w-75">
            ...
            corporis at in, assumenda debitis architecto perferendis provident
            distinctio ipsam!
          </h5>
        </div>
...
const Brands = ref([
  ...
  {
    group: "B",
    list: ["BDK Parfums", "Burberry"],
  },
  {
    group: "C",
    list: ["CSA Parfums", "CCS"],
  },
]);
