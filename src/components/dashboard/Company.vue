<template>
  ...
  <Dialog
    ...
    :modal="true"
    :closable="true"
    :header="'edit #' + currentData.id + ' company'"
    :breakpoints="{ '1199px': '85vw', '575px': '95vw' }"
  >
    <div
      class="w-100 d-flex justify-content-center align-items-center flex-wrap"
  ...
  <Dialog
    ...
    :modal="true"
    :closable="true"
    :header="'Delete #' + currentData.id + ' company'"
    :style="{ width: '35rem' }"
    :breakpoints="{ '1199px': '85vw', '575px': '95vw' }"
  >
    <span v-if="1 == 1">
      Are you sure you want to delete {{ currentData.enName }} company ?</span
    >
    <span v-else>
      Are you sure you want to delete {{ currentData.arName }} company ?</span
    >
    <template #footer>
      <Button
        icon="pi pi-trash"
